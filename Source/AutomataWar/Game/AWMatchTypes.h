...
struct FAWMatchOutcome
{
	...
	UPROPERTY(BlueprintReadOnly) int32 WinnerSlot = -1;
	UPROPERTY(BlueprintReadOnly) int32 FinalTick = 0;
	UPROPERTY(BlueprintReadOnly) int32 HP0 = 0;
	UPROPERTY(BlueprintReadOnly) int32 HP1 = 0;
};
...
struct FAWReplayInfo
{
	...
	UPROPERTY(BlueprintReadOnly) int32 FileSizeBytes = 0;
};
