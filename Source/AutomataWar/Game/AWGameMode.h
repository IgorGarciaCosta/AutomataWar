...
public:
    ...
    /** Whether slot 1 is currently generated by the deterministic AI planner. */
...
protected:
    ...
    /** Pure queue, reservation, and submission bookkeeping for both slots. */
    FAWSubmissionState SubmissionState;
